...
export default function CommitList({ data }: { data: CommitView[] }) {
  ...
  const filteredCommits = filter === "all" ? commits : commits.filter(c => c.label === filter);
          ...
          <div className="mb-8">
            <div className="flex items-start justify-between gap-4 mb-4">
              ...
              <div className="flex gap-2">
                <div onClick={() => setFilter((e) => e === "major" ? "all" : "major")} className="cursor-pointer rounded-lg bg-white dark:bg-zinc-900 border border-zinc-200 dark:border-zinc-800 px-4 py-2 shadow-sm">
                ...
                <div onClick={() => setFilter((e) => e === "minor" ? "all" : "minor")} className="cursor-pointer rounded-lg bg-white dark:bg-zinc-900 border border-zinc-200 dark:border-zinc-800 px-4 py-2 shadow-sm">
